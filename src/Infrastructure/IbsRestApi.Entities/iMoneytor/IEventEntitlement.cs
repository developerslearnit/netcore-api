...
public partial class IEventEntitlement
{
    public int IdEventEntitlement { get; set; }
    ...
    public int? EntitledPosition { get; set; }
    public int? QuantityDue { get; set; }
    public decimal? GrossIncomeDue { get; set; }
    public decimal? TaxAmount { get; set; }
    public decimal? NetIncomeDue { get; set; }
